...
void	ScavTrap::attack( const std::string & target) {
	...
	{
		std::cout << "ScavTrap " << this->getName() << " attacks " << target << " causing " << this->_attack_damage << " points of damage" << std::endl;
		this->_energy_points--;
	}
}
...
void	ScavTrap::guardGate( ) {
	...
	if (this->_hit_points == 0)
		std::cout << "ScavTrap " << this->getName() << " is dead and cannot guard.." << std::endl;
	else if (this->_energy_points == 0)
		std::cout << "ScavTrap " << this->getName() << " has not enough energy to guard.." << std::endl;
	else
	{
